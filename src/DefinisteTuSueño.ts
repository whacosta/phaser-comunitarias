...
class DefinisteTuSueño extends Phaser.State {
  ...
  create() {
    ...
    var text = this.game.add.text(this.game.world.centerX, margenTop, "¿Definiste tu sueño? No esperes más y empieza a llevarlo a la realidad. Aflatoun Habla.", style);
